...
export type SitePluginPluginOptionsPluginsPluginOptions = {
  ...
  fontFile?: Maybe<
    Array<Maybe<SitePluginPluginOptionsPluginsPluginOptionsFontFile>>
  >
  iconFile?: Maybe<Scalars["String"]>
  timeout?: Maybe<Scalars["Int"]>
}
...
export type GetSitelistQuery = {
  site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, "title">> }>
  allMarkdownRemark: {
    nodes: Array<
      Pick<MarkdownRemark, "excerpt"> & {
        fields?: Maybe<Pick<Fields, "slug">>
        frontmatter?: Maybe<Pick<Frontmatter, "date" | "title" | "description">>
      }
    >
  }
}
...
export type BlogPostBySlugQuery = {
  ...
  markdownRemark?: Maybe<
    Pick<MarkdownRemark, "id" | "excerpt" | "html" | "rawMarkdownBody"> & {
